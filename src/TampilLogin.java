 ...
 */
public class TampilLogin extends javax.swing.JFrame {

    /**
     * Creates new form TampilLogin
     */
    public TampilLogin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logo smartt.png"))); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (login.authenticate(username, password)) {
            // If authentication is successful, open the Inventory frame
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilLogin().setVisible(true);
            }
        });
    }
